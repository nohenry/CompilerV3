...
@__const.main.d = private unnamed_addr constant [1 x i32] [i32 5], align 4
...
define dso_local i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %3, i8* align 4 bitcast ([1 x i32]* @__const.main.d to i8*), i64 4, i1 false)
  %4 = getelementptr inbounds [1 x i32], [1 x i32]* %1, i64 0, i64 5
